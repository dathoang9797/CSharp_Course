...
// int b = 7;
// int h = ++b;
// Console.WriteLine($"b={b}, h={h}");

//Input: Nhập vào 1 số thực
//Output: In ra số làm tròn
// 8.6=> 9
// 7.3 => 7
...
//Cách tự làm
// double divisionRemainder = num % 1;
// double result;
// if (divisionRemainder >= 0.75)
// {
//     result = (int)num + 1;
// }
// else if (divisionRemainder >= 0.25)
// {
//     result = (int)num + 0.5;
// }
// else
...
//Cách thầy
// string[] a = { "Chan", "Le" };
// Console.WriteLine($"{n} la so {a[n % 2]}");


//Input: Nhap thang bat ky (bo qua nam nhuan)
//Output: tinh so ngay trong thang
//31: 1 ,3 ,5, 7 , 8, 10, 12
//30: 4, 6, 9, 11
//28: 2

// Console.Write("Nhap so thang bat ky: ");
// int m = Convert.ToInt32(Console.ReadLine());
// //Cho biet thang do co bao nhieu ngay
// int[] a = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
// Console.WriteLine($"{m} co {a[m - 1]} ngay");

//Tạo một số ngẫu nhiên
// 

//Ngau nhien 1 so nguyen từ [0-5]
// Console.WriteLine($"Ngau nhien tu 0-5: {rand.Next(6)}");
// Console.WriteLine($"Ngau nhien tu 0-5: {rand.Next(6)}");
// Console.WriteLine($"Ngau nhien tu 0-5: {rand.Next(6)}");
// Console.WriteLine($"Ngau nhien tu 0-5: {rand.Next(6)}");
// Console.WriteLine($"Ngau nhien tu 0-5: {rand.Next(6)}");
...
//Ngau nhien 1 so nguyen từ [8-12]
// Console.WriteLine($"Ngau nhien tu 8-12: {rand.Next(8, 13)}");
// Console.WriteLine($"Ngau nhien tu 8-12: {rand.Next(8, 13)}");
// Console.WriteLine($"Ngau nhien tu 8-12: {rand.Next(8, 13)}");
// Console.WriteLine($"Ngau nhien tu 8-12: {rand.Next(8, 13)}");
// Console.WriteLine($"Ngau nhien tu 8-12: {rand.Next(8, 13)}");

//Ngau nhien 1 so nguyen từ [0-1]
// Console.WriteLine($"Ngau nhien tu 0-1: {rand.NextDouble()}");
// Console.WriteLine($"Ngau nhien tu 0-1: {rand.NextDouble()}");
// Console.WriteLine($"Ngau nhien tu 0-1: {rand.NextDouble()}");
// Console.WriteLine($"Ngau nhien tu 0-1: {rand.NextDouble()}");
// Console.WriteLine($"Ngau nhien tu 0-1: {rand.NextDouble()}");
...
//Viết chương trình trò chơi Bao Búa Kéo
//Người đấu với máy máy chọn ngẫu nhiên
...
// int com = rand.Next(3);
// Console.Write("Moi ban chon 0:Bao, 1:Bua, 2:Keo: ");
// int human = Convert.ToInt32(Console.ReadLine());
// string[] a = { "Bao", "Búa", "Kéo" };
// Console.WriteLine($"Người chọn: {a[human]}");
// Console.WriteLine($"Máy chọn: {a[com]}");
//
// string[,] result =
// {
//     { "Hòa", "Thắng", "Thua" },
...
// };
//
// Console.WriteLine(result[human, com]);
...
// Console.WriteLine($"P(z={z}) = {matrix[r, c]}");

        string[] can = { "Giáp", " Ất", "Bính", "Đinh", " Mậu", "Kỷ", " Canh", "Tân", " Nhâm", "Quý" };
        string[] chi = { "Tỷ", "Sửu", "Dần", "Mão", "Thìn", "Tỵ", "Ngọ", "Mùi", "Thân", "Dậu", "Tuất", "Hợi" };
        Console.Write("Nhap vao nam: ");
        int y = Convert.ToInt32(Console.ReadLine());
        Console.Write($"Nam am lich {can[y % 10]} {chi[y % 12]}");
    }
}